<template>
  <div>
    <p>
      ...
      odio ut semper pellentesque, nibh diam tincidunt ex, id gravida ante purus
      sed nibh. Aenean interdum faucibus dignissim. Vestibulum et neque
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      this.$router.push('/with-parent-route/step2')
    },
  },
}
</script>
